...
*       int nCmdShow            Controls how window is to be shown
*
=============================================================================*/
int PASCAL WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevious, LPWSTR lpszCmdLine, int nCmdShow)
{
    ...
    */
    ...
    (
        ...
        L"A cool window",	    //lpWindowName (title bar text)
...
*       UINT uMsg               The value of the message we receive
*       WPARAM wParam           Msg data - usually lightweight (32 bits)
*       LPARAM lParam           Msg data - usually complex (32/64 bits)
*
=============================================================================*/
LRESULT WINAPI WindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    //It's usually helpful to have a static RECT to hold the clientRect (the size of the window)
    static RECT clientRect;
    RECT textRect = (RECT){ 0, 0, clientRect.right, 25};
    wchar_t text[] = L"Hello Windows!";    
